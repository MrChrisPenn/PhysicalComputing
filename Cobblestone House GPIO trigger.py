...
with Python and Minecraft. I have slightly modified and extended the code to build a
modified version of the house which is triggered by two jumper cables being connected
to Gpio pin 3 and ground. This version creates a 3-4 storey version which creates 2 sides of a "road".
...
while True:
    Switch.wait_for_press()
        # Determine the Player's current position.
    No_Of_Houses = int(input("Please type in the number of houses you would like"))
    x,y,z = mc.player.getTilePos()
    msg = "Printing Street with "+str(No_Of_Houses)+" houses on each side"
    mc.postToChat(msg)
